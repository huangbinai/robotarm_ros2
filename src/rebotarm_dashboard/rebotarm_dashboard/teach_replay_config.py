...
from rebotarm_teach.teach_replay_coordinator import TeachReplayLimits
from rebotarm_teach.teach_replay_trajectory_builder import TeachReplayTrajectoryConfig
from rebotarm_teach.teach_replay_workflow import TeachReplayPreparationConfig


class TeachReplayParameterAdapter:
    """Translate dashboard ROS parameters into teach replay domain configs."""
    ...
    def velocity_limits(self, joint_names: tuple[str, ...]) -> float | tuple[float, ...]:
    ...
    def preparation(
        ...
        *,
        ...
        return TeachReplayPreparationConfig(
            ...
            max_acceleration_rad_s2=float(self._value("max_replay_acceleration_rad_s2")),
            max_jerk_rad_s3=float(self._value("max_replay_jerk_rad_s3")),
            time_parameterization_method=str(self._value("time_parameterization_method")),
    ...
    def collision(
        ...
        *,
        ...
        return CollisionPrecheckConfig(
            ...
            timeout_sec=max(float(self._value("collision_check_timeout_sec")), 0.1),
            default_joint_positions=default_joint_positions,
        )

    def trajectory(self, joint_names: tuple[str, ...]) -> TeachReplayTrajectoryConfig:
